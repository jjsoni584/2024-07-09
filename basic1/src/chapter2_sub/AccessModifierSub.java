...
// import chaper2.AccessModifierRun;
...
public class AccessModifierSub {
		...
		void method() {
			...
			// 접근 제어자가 각각 protected, default, private이기 때문에 외부 패키지에서 접근이 불가능
...
//		instance.privateVariable = 0;
		...
		// AccessModifier의 publicVariable, prtectedVariable 필드는
		// 접근제어자가 각각 public, protected이기 때문에 자손 클래스에서 접근 가능
